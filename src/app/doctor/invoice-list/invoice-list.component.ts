...
export class InvoiceListComponent implements OnInit {
  ...
  downloadInvoicePDF() {
    ...
    yPos += 7;
    drawField('Issue Date', new Date(inv.issuedDate).toLocaleDateString('en-US', {
    ...
    doc.text('For payment inquiries, please contact our billing department.', 25, yPos + 5);

    // Footer
    doc.setFontSize(8);
    doc.text('This is a computer-generated invoice and does not require a signature.', pageWidth / 2, pageHeight - 20, { align: 'center' });
